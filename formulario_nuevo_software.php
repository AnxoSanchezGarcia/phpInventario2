...
<html>
    ...
    <body>
        ...
        <!--
            * Funciona do mesmo xeito que en inventario
            * Se hai algún erro voltamos aquí e os arrays gardados en variables de sesión conterán os DATOS e mais os ERROS
            * polo que IMPRIMIMOS os valores dos arrays onde estexan mal
        -->
